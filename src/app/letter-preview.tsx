...
export default function LetterPreview({
  ...
  return (
    <div
      className={`w-14 h-14 tiny:w-12 tiny:h-12 border-2 dark:border-zinc-600 ${borderClass} rounded flex justify-center items-center text-3xl tiny:text-2xl font-bold ${
        className || ""
